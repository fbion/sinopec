...
public enum BizExceptionEnum {
    ...
    MOBILE_COLLECT_ERROR_IN_STATION_SENSOR_NOT_EXIST(200013,"无进站摄像设备"),
    MOBILE_COLLECT_ERROR_OUT_STATION_SENSOR_NOT_EXIST(200014,"无站外摄像设备"),
    MOBILE_COLLECT_ERROR_IN_STATION_COLLECT_SENSOR_NOT_EXIST(200015,"无进站采集设备"),
    MOBILE_COLLECT_ERROR_OUT_STATION_COLLECT_SENSOR_NOT_EXIST(200016,"无站外采集设备"),
    MOBILE_COLLECT_ERROR_OUT_STATION_ALL_SENSOR_NOT_EXIST(200017,"无站外采集设备和站外摄像设备"),
    MOBILE_COLLECT_ERROR_IN_STATION_ALL_SENSOR_NOT_EXIST(200018,"无进站采集设备和进站摄像设备"),
    
    /*****设备管理模块*****/
    SENSOR_ERROR_NULL(300001,"暂无相关采集设备和油站摄相机"),
