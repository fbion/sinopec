...
/**
  ...
  * @Description:工具类 
  * @author think
  * @date 2018年9月3日 下午2:51:48
  *
  */
public class AesUtil {
	
    private static final String key = "S#@#G" ;
	...
	public static String base64Encode(byte[] bytes){
		return Base64AllHelper.encodeBytes(bytes);
	}
	...
	public static byte[] base64Decode(String base64Code) throws Exception{
		return StringUtils.isBlank(base64Code) ? null : Base64AllHelper.decode(base64Code);
	}
    ...
    public static String aesDecrypt(String encryptStr) throws Exception {
        return StringUtils.isBlank(encryptStr) ? null : aesDecryptByBytes(base64Decode(encryptStr), key);
    }
