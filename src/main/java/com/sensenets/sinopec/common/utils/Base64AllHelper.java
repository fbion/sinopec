...
public class Base64AllHelper {
    ...
    public static void encode(java.nio.ByteBuffer raw, java.nio.ByteBuffer encoded) {
        ...
        while (raw.hasRemaining()) {
            ...
            raw.get(raw3, 0, rem);
            Base64AllHelper.encode3to4(enc4, raw3, rem, Base64AllHelper.NO_OPTIONS);
            encoded.put(enc4);
        } // end input remaining
    }
     ...
     *            Specified options
     * @return The Base64-encoded object
     * @see Base64AllHelper#GZIP
     * @see Base64AllHelper#DO_BREAK_LINES
     * @throws java.io.IOException
     *             if there is an error
     * @since 2.0
     */
    public static String encodeObject(java.io.Serializable serializableObject, int options) throws java.io.IOException {
        ...
        try {
            ...
            b64os = new Base64AllHelper.OutputStream(baos, ENCODE | options);
            if ((options & GZIP) != 0) {
                // Gzip
    ...
    public static byte[] encodeBytesToBytes(byte[] source) {
        byte[] encoded = null;
        try {
            encoded = encodeBytesToBytes(source, 0, source.length, Base64AllHelper.NO_OPTIONS);
        } catch (java.io.IOException ex) {
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException {
        ...
        if ((options & GZIP) != 0) {
            java.io.ByteArrayOutputStream baos = null;
            java.util.zip.GZIPOutputStream gzos = null;
            Base64AllHelper.OutputStream b64os = null;
    ...
    public static byte[] decode(byte[] source) throws java.io.IOException {
        byte[] decoded = null;
        // try {
        decoded = decode(source, 0, source.length, Base64AllHelper.NO_OPTIONS);
        // } catch( java.io.IOException ex ) {
    ...
    public static void encodeToFile(byte[] dataToEncode, String filename) throws java.io.IOException {
        ...
        Base64AllHelper.OutputStream bos = null;
        try {
            bos = new Base64AllHelper.OutputStream(new java.io.FileOutputStream(filename), Base64AllHelper.ENCODE);
    ...
    public static void decodeToFile(String dataToDecode, String filename) throws java.io.IOException {
        ...
        Base64AllHelper.OutputStream bos = null;
        try {
            bos = new Base64AllHelper.OutputStream(new java.io.FileOutputStream(filename), Base64AllHelper.DECODE);
    ...
    public static byte[] decodeFromFile(String filename) throws java.io.IOException {
        ...
        Base64AllHelper.InputStream bis = null;
        try {
            ...
            // Open a stream
            bis = new Base64AllHelper.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64AllHelper.DECODE);
    ...
    public static String encodeFromFile(String filename) throws java.io.IOException {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64AllHelper.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64AllHelper.ENCODE);
            ...
            // Save in a variable to return
            encodedData = new String(buffer, 0, length, Base64AllHelper.PREFERRED_ENCODING);
    ...
    public static void encodeFileToFile(String infile, String outfile) throws java.io.IOException {
        ...
        String encoded = Base64AllHelper.encodeFromFile(infile);
    ...
    public static void decodeFileToFile(String infile, String outfile) throws java.io.IOException {
        ...
        byte[] decoded = Base64AllHelper.decodeFromFile(infile);
        java.io.OutputStream out = null;
        try {
            out = new java.io.BufferedOutputStream(new java.io.FileOutputStream(outfile));
            out.write(decoded);
    ...
    /**
     * A {@link Base64AllHelper.InputStream} will read data from another
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link Base64AllHelper.InputStream} in DECODE mode.
         *
         * @param in
        ...
        /**
         * Constructs a {@link Base64AllHelper.InputStream} in either ENCODE or
         * DECODE mode.
         * <p>
         * Valid options:
         * 
         ...
         * @param options
         *            Specified options
         * @see Base64AllHelper#ENCODE
         * @see Base64AllHelper#DECODE
         * @see Base64AllHelper#DO_BREAK_LINES
         * @since 2.0
         */
    ...
    /**
     * A {@link Base64AllHelper.OutputStream} will write data to another
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link Base64AllHelper.OutputStream} in ENCODE mode.
         *
         * @param out
        ...
        /**
         * Constructs a {@link Base64AllHelper.OutputStream} in either ENCODE or
         * DECODE mode.
         * <p>
         * Valid options:
         * 
            ...
            // Else, Decoding
                ...
                if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    if (position >= bufferLength) { // Enough to output.
                        ...
                        int len = Base64AllHelper.decode4to3(buffer, 0, b4, 0, options);
                        out.write(b4, 0, len);
                        position = 0;
                    } // end if: enough to output
    ...
    public static void main(String[] args) throws IOException {
        String encode = "";
        byte[] b = decode(encode);
        String hex = ByteHelper.BinaryToHexString(b);
        System.out.println(hex);
        System.out.println();
        byte[] a = ByteHelper.HexStringToBinary(hex);
        System.out.println(encodeBytes(a).length());
        if(encode.equals(encodeBytes(a))){
