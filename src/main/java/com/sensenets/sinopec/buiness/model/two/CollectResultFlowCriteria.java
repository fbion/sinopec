...
public class CollectResultFlowCriteria {
    ...
    /**
     *  构造查询条件:public.collect_result_flow
     */
    public CollectResultFlowCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    /**
     *  设置排序字段:public.collect_result_flow
     *
    ...
    /**
     *  获取排序字段:public.collect_result_flow
     */
    ...
    /**
     *  设置过滤重复数据:public.collect_result_flow
     *
    ...
    /**
     *  是否过滤重复数据:public.collect_result_flow
     */
    ...
    /**
     *  获取当前的查询条件实例:public.collect_result_flow
     */
    ...
    /**
     *  创建一个查询条件:public.collect_result_flow
     */
    ...
    /**
     *  内部构建查询条件对象:public.collect_result_flow
     */
    ...
    /**
     *  清除查询条件:public.collect_result_flow
     */
    public void clear() {
        oredCriteria.clear();
        orderByClause = null;
