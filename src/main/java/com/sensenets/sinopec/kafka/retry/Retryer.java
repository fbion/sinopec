...
public final class Retryer<V> {
    private final StopStrategy<V> stopStrategy;
    private final WaitStrategy<V> waitStrategy;
     ...
     */
    public Retryer(@Nonnull StopStrategy<V> stopStrategy,
                   @Nonnull WaitStrategy<V> waitStrategy,
    ...
    public Retryer(@Nonnull AttemptTimeLimiter<V> attemptTimeLimiter,
                   @Nonnull StopStrategy<V> stopStrategy,
                   @Nonnull WaitStrategy<V> waitStrategy,
                   @Nonnull Predicate<Attempt<V>> rejectionPredicate) {
