...
public class RetryerBuilder<V> {
    ...
    private StopStrategy<V> stopStrategy;
    private WaitStrategy<V> waitStrategy;
     ...
     */
    public RetryerBuilder<V> withWaitStrategy(@Nonnull WaitStrategy<V> waitStrategy) throws IllegalStateException {
     ...
     */
    public RetryerBuilder<V> withStopStrategy(@Nonnull StopStrategy<V> stopStrategy) throws IllegalStateException {
    ...
    public Retryer<V> build() {
        ...
        StopStrategy<V> theStopStrategy = stopStrategy == null ? StopStrategies.<V>neverStop() : stopStrategy;
        WaitStrategy<V> theWaitStrategy = waitStrategy == null ? WaitStrategies.<V>noWait() : waitStrategy;
